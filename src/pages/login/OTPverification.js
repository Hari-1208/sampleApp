        ...
        <SafeAreaView style={{flex:1,backgroundColor:"#FFFFFF"}}>
            <View style={{flex:1,backgroundColor:'#FFFFFF'}}>
                ...
                <View style={{flex:0.1,marginTop:'20%'}}>
                    ...
                    <Text style={styles.caption2}>to +91 9150658829</Text>
                    {/* {textinput} */}
                </View>
                ...
                <View style={{flex:0.15,marginTop:'15%'}}>
                    ...
                    <TouchableOpacity style={styles.button1} onPress={() => props.navigation.navigate("OTPpage2")}>
                        <Text style={styles.continue} >Verify Now</Text>
                    </TouchableOpacity>
                </View>
                <View style={{flex:0.3}}  />
...
const styles = StyleSheet.create({
    ...
    caption2:{
        width:"70%",height:'80%',fontSize:15,color:'#333333',marginLeft:'35%'
    },
    textBox1:{
