...
const bookingComp=(props) => {
    ...
    const styles = StyleSheet.create({
      total:{
        flex:0.2,flexDirection:'row',marginTop:'3%',backgroundColor:'#FFFAE9',borderRadius:4,width:'90%',height:110,alignSelf:'center'
      },
      icons:{
        width:'90%',height:'80%',marginTop:'11%',borderRadius:4
      },
      heading:{
